...
public class GetLikedVideoTask extends AsyncTask<Void, Void, List<SearchResult>> {
    Activity mActivity;
    String mEmail;
    String mToken;

    GetLikedVideoTask(Activity activity,String token,String id) {
    ...
    protected List<SearchResult> getLikedVideo() throws IOException {
        try {
        	...
        	String response = sh.makeServiceCall(MainActivity.SERVER_URL+"/likes", sh.POST, params);
    ...
    protected void onPostExecute(List<SearchResult> result) {
    	((MainActivity)mActivity).likeVideoResult(result);
    }
